...
x_train, y_train, x_test, y_test = Data.loadCifar(numTest=-1)
...
np.savez(os.path.join('../../datasets/cifar10_mobileNetV2'), x_train=x_train, y_train=y_train, x_test=x_test, y_test=y_test)
