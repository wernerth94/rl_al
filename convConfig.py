...
# training loop
MIN_INTERACTIONS = 200000
WARMUP = 100 # int(0.03*MIN_INTERACTIONS)
...
GL = Misc.parameterPlan(3, BUDGET, warmup=WARMUP + int(0.025*MIN_INTERACTIONS), conversion=int(0.5*MIN_INTERACTIONS))
